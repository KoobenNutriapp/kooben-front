const PrivacyPolicies = () => {
  return (
    <>
      ...
      <p>
        El presente Política de Privacidad establece los términos en que Kooben
      ...
      <p>
        Kooben está altamente comprometido para cumplir con el compromiso de
      ...
      <p>
        Kooben Se reserva el derecho de cambiar los términos de la presente
